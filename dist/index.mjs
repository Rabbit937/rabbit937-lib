...
function t(i = 0, e = 100, l = "round") {
  return Math[l](Math.random() * (e - i) + i);
}
function W(i = 10) {
...
function f(i) {
  ...
  for (let e = i.length - 1; e > 0; e--) {
    const l = Math.floor(Math.random() * (e + 1)), n = i[e];
    i[e] = i[l], i[l] = n;
  }
  return i;
}
function A() {
  const i = t(0, r.length - 1);
  return r[i];
}
function K([i, ...e]) {
  return i ? i.toUpperCase() + e.join("") : "";
}
function d(i) {
...
function T(i, e) {
  return c(i) ? Object.prototype.hasOwnProperty.call(i, e) : !1;
}
const a = typeof window < "u", z = !a, s = /iPhone|phone|android|iPod|pad|iPad/i;
function k() {
  return a ? s.test(o()) : !1;
}
function L() {
...
const S = /Android/i.test(o()), u = /iPhone|iPod|iPad|iOS/i.test(o()), h = /uni-app|html5plus/.test(o()), b = /MicroMessenger/i.test(o()), x = /\sQQ|mqqbrowser|qzone|qqbrowser/i.test(o()), G = /mqqbrowser|qqbrowser/i.test(o()), w = /qzone\/.*_qz_([\d.]+)/i.test(o()), _ = /(weibo).*weibo__([\d.]+)/i.test(o()), H = /(baiduboxapp)\/([\d.]+)/i.test(o());
function m(i, { immediate: e } = { immediate: !0 }) {
  a && (e && window.addEventListener("load", i, !1), window.addEventListener(
...
function C(i) {
  return /^1[3456789]\d{9}$/.test(String(i));
}
function O(i) {
...
function N(i) {
  const e = /^([1-6][1-9]|50)\d{4}(18|19|20)\d{2}((0[1-9])|10|11|12)(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$/, l = /^([1-6][1-9]|50)\d{4}\d{2}((0[1-9])|10|11|12)(([0-2][1-9])|10|20|30|31)\d{3}$/;
  return e.test(i) || l.test(i);
}
function X(i) {
  return /^([1-9]{1})(\d{15}|\d{16}|\d{18})$/.test(i);
}
function v(i) {
...
export {
  ...
  _ as isWeibo,
  b as isWeixin,
  s as mobileDevicesRegExp,
  p as randomBoolean,
  t as randomNumber,
  W as randomString,
  A as randomUserAgent,
  f as shuffle,
  r as userAgents,
  m as watchResize
};
